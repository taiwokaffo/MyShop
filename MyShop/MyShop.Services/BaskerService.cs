...
{
    public class BaskerService:IBasketService
    {
        ...
        public BaskerService(IRepository<Product> ProductContext, IRepository<Basket> BasketContext)
        {
        ...
        public BasketSummaryViewModel GetBasketSummary(HttpContextBase httpContext)
        {
            ...
            if (basket != null)
            {
                ...
                decimal? basketTotal = (from item in basket.BasketItems
                                        join p in
        productContext.Collection() on item.ProductId equals p.Id
